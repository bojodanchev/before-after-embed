      ...
      <div class="wrap" part="container" role="group" aria-label="Before After editor">
        ...
        <div id="placeholder" class="slider" style="display: block;" role="region">
          <div id="placeholder-container" style="position: relative; width: 100%; padding-bottom: 75%; background: #000; overflow: hidden; border-radius: 8px;">
            <img id="placeholder-after" src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 800 600'%3E%3Cdefs%3E%3ClinearGradient id='g1' x1='0%25' y1='0%25' x2='100%25' y2='100%25'%3E%3Cstop offset='0%25' style='stop-color:%234CAF50;stop-opacity:1'/%3E%3Cstop offset='100%25' style='stop-color:%23388E3C;stop-opacity:1'/%3E%3C/linearGradient%3E%3C/defs%3E%3Crect width='800' height='600' fill='url(%23g1)'/%3E%3Ctext x='400' y='280' font-family='system-ui,-apple-system,sans-serif' font-size='48' font-weight='bold' fill='white' text-anchor='middle' opacity='0.95'%3E%E2%9C%A8 AFTER%3C/text%3E%3Ctext x='400' y='340' font-family='system-ui,-apple-system,sans-serif' font-size='24' fill='white' text-anchor='middle' opacity='0.85'%3EClean %26 Detailed%3C/text%3E%3C/svg%3E" alt="After - clean car" style="position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover;">
            <img id="placeholder-before" src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 800 600'%3E%3Cdefs%3E%3ClinearGradient id='g2' x1='0%25' y1='0%25' x2='100%25' y2='100%25'%3E%3Cstop offset='0%25' style='stop-color:%236c5ce7;stop-opacity:1'/%3E%3Cstop offset='100%25' style='stop-color:%234c3398;stop-opacity:1'/%3E%3C/linearGradient%3E%3C/defs%3E%3Crect width='800' height='600' fill='url(%23g2)'/%3E%3Ctext x='400' y='280' font-family='system-ui,-apple-system,sans-serif' font-size='48' font-weight='bold' fill='white' text-anchor='middle' opacity='0.95'%3E%F0%9F%9A%97 BEFORE%3C/text%3E%3Ctext x='400' y='340' font-family='system-ui,-apple-system,sans-serif' font-size='24' fill='white' text-anchor='middle' opacity='0.85'%3ENeeds Detailing%3C/text%3E%3C/svg%3E" alt="Before - dirty car" style="position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover; clip-path: inset(0 50% 0 0);">
