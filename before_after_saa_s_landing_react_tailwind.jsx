      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-neutral-950/80 backdrop-blur">
        <Container className="flex h-14 items-center justify-between">
          ...
          <nav className="hidden items-center gap-6 text-sm text-white/80 md:flex">
            ...
            <a href="/client" className="hover:text-white">Client Portal</a>
          </nav>
          <div className="flex items-center gap-2">
            <a href="/client"><Button variant="secondary" className="hidden bg-white/10 text-white hover:bg-white/20 sm:inline-flex">Sign in</Button></a>
        ...
        <Container className="py-16 sm:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              <a href="/client"><Button size="lg" variant="secondary" className="bg-white/10 text-white hover:bg-white/20">
                Client Portal
              </Button></a>
            </div>
          </div>
